...
export const profileUrl  = (path)                 => path ? `${IMG_BASE}/w185${path}` : null;
...
export const getMovieDetails   = (id)       => fetchTMDB(`/movie/${id}`, { append_to_response: 'credits,videos,similar' });
export const searchMovies      = (query, page = 1) => fetchTMDB('/search/movie', { query, page });
export const discoverMovies    = (params = {})     => fetchTMDB('/discover/movie', { sort_by: 'popularity.desc', ...params });
